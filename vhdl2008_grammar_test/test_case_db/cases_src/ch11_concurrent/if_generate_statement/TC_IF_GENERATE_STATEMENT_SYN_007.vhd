-- =============================================================
-- Case ID: TC_IF_GENERATE_STATEMENT_SYN_007
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: if_generate_statement: with for-generate and block structure
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity if_generate_statemen_q3 is
  port (
    result : out integer
  );
end entity if_generate_statemen_q3;

architecture comprehensive of if_generate_statemen_q3 is
