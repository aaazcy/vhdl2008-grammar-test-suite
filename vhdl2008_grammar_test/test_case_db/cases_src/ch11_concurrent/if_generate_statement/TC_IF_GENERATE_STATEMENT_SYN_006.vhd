-- =============================================================
-- Case ID: TC_IF_GENERATE_STATEMENT_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: if_generate_statement: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity if_generate_statemen_q2 is
  port (
    result : out integer
  );
end entity if_generate_statemen_q2;

architecture comprehensive of if_generate_statemen_q2 is
