-- =============================================================
-- Case ID: TC_CASE_GENERATE_STATEMENT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: case_generate_statement: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity case_generate_statem_q2 is
  port (
    result : out integer
  );
end entity case_generate_statem_q2;

architecture comprehensive of case_generate_statem_q2 is
