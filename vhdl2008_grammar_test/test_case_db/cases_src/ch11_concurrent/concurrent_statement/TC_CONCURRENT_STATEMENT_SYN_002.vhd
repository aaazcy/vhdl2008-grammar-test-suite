-- =============================================================
-- Case ID: TC_CONCURRENT_STATEMENT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: concurrent_statement: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity concurrent_statement_q2 is
  port (
    result : out integer
  );
end entity concurrent_statement_q2;

architecture comprehensive of concurrent_statement_q2 is
