-- =============================================================
-- Case ID: TC_CONCURRENT_ASSERTION_STATEMENT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: concurrent_assertion_statement: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity concurrent_assertion_q2 is
  port (
    result : out integer
  );
end entity concurrent_assertion_q2;

architecture comprehensive of concurrent_assertion_q2 is
