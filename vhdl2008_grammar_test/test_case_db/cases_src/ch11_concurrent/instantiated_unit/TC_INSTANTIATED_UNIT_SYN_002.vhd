-- =============================================================
-- Case ID: TC_INSTANTIATED_UNIT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: instantiated_unit: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity instantiated_unit_q2 is
  port (
    result : out integer
  );
end entity instantiated_unit_q2;

architecture comprehensive of instantiated_unit_q2 is
