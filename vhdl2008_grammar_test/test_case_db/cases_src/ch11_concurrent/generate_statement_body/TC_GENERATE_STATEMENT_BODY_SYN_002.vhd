-- =============================================================
-- Case ID: TC_GENERATE_STATEMENT_BODY_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: generate_statement_body: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity generate_statement_b_q2 is
  port (
    result : out integer
  );
end entity generate_statement_b_q2;

architecture comprehensive of generate_statement_b_q2 is
