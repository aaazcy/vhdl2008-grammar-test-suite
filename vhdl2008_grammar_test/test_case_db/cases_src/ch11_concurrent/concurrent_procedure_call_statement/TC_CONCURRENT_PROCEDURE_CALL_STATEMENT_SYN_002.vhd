-- =============================================================
-- Case ID: TC_CONCURRENT_PROCEDURE_CALL_STATEMENT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: concurrent_procedure_call_statement: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity concurrent_procedure_q2 is
  port (
    result : out integer
  );
end entity concurrent_procedure_q2;

architecture comprehensive of concurrent_procedure_q2 is
