-- =============================================================
-- Case ID: TC_CONCURRENT_SIGNAL_ASSIGNMENT_STATEMENT_SYN_007
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: concurrent_signal_assignment_statement: with for-generate and block structure
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity concurrent_signal_as_q3 is
  port (
    result : out integer
  );
end entity concurrent_signal_as_q3;

architecture comprehensive of concurrent_signal_as_q3 is
