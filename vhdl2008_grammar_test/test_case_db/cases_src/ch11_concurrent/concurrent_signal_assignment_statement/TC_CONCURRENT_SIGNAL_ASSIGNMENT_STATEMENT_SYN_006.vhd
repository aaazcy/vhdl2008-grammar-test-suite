-- =============================================================
-- Case ID: TC_CONCURRENT_SIGNAL_ASSIGNMENT_STATEMENT_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: concurrent_signal_assignment_statement: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity concurrent_signal_as_q2 is
  port (
    result : out integer
  );
end entity concurrent_signal_as_q2;

architecture comprehensive of concurrent_signal_as_q2 is
