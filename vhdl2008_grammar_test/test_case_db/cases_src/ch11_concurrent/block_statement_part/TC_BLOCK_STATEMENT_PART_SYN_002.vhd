-- =============================================================
-- Case ID: TC_BLOCK_STATEMENT_PART_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: block_statement_part: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity block_statement_part_q2 is
  port (
    result : out integer
  );
end entity block_statement_part_q2;

architecture comprehensive of block_statement_part_q2 is
