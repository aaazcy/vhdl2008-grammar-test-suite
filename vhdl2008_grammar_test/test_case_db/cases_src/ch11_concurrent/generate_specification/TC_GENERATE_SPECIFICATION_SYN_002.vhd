-- =============================================================
-- Case ID: TC_GENERATE_SPECIFICATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: generate_specification: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity generate_specificati_q2 is
  port (
    result : out integer
  );
end entity generate_specificati_q2;

architecture comprehensive of generate_specificati_q2 is
