-- =============================================================
-- Case ID: TC_CONCURRENT_SIMPLE_SIGNAL_ASSIGNMENT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: concurrent_simple_signal_assignment: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity concurrent_simple_si_q2 is
  port (
    result : out integer
  );
end entity concurrent_simple_si_q2;

architecture comprehensive of concurrent_simple_si_q2 is
