-- =============================================================
-- Case ID: TC_PROCESS_DECLARATIVE_ITEM_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: process_declarative_item: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity process_declarative_q2 is
  port (
    result : out integer
  );
end entity process_declarative_q2;

architecture comprehensive of process_declarative_q2 is
