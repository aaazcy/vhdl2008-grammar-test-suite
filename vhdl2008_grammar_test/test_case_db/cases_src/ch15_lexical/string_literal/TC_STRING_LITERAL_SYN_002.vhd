-- =============================================================
-- Case ID: TC_STRING_LITERAL_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: string_literal: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity string_literal_q2 is
  port (
    result : out integer
  );
end entity string_literal_q2;

architecture comprehensive of string_literal_q2 is
