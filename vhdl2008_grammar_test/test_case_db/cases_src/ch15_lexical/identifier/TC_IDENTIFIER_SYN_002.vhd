...
-- Case Type: Positive
-- Test Focus: identifier: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity identifier_q2 is
  port (
    result : out integer
  );
end entity identifier_q2;

architecture comprehensive of identifier_q2 is
