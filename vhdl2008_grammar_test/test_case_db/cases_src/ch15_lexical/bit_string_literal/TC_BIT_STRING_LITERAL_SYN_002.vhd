-- =============================================================
-- Case ID: TC_BIT_STRING_LITERAL_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: bit_string_literal: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity bit_string_literal_q2 is
  port (
    result : out integer
  );
end entity bit_string_literal_q2;

architecture comprehensive of bit_string_literal_q2 is
