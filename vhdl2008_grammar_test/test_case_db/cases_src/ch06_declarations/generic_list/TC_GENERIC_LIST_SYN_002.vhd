-- =============================================================
-- Case ID: TC_GENERIC_LIST_SYN_002
-- Rule Type: Syntax
-- Related Rule ID: BNF_GENERIC_LIST
-- Standard Reference: IEEE 1076-2008 Section 6.5.6.2
-- Production: generic_list ::= generic_interface_list
-- Case Type: Positive
-- Test Focus: generic_list: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity generic_list_q2 is
  port (
    result : out integer
  );
end entity generic_list_q2;

architecture comprehensive of generic_list_q2 is
