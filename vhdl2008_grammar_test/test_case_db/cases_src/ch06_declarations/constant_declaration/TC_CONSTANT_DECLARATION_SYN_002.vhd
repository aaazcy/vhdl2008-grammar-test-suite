-- =============================================================
-- Case ID: TC_CONSTANT_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: constant_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity constant_declaration_q2 is
  port (
    result : out integer
  );
end entity constant_declaration_q2;

architecture comprehensive of constant_declaration_q2 is
