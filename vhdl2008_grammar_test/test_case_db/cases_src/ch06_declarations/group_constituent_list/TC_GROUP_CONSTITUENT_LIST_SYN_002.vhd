-- =============================================================
-- Case ID: TC_GROUP_CONSTITUENT_LIST_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: group_constituent_list: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity group_constituent_li_q2 is
  port (
    result : out integer
  );
end entity group_constituent_li_q2;

architecture comprehensive of group_constituent_li_q2 is
