-- =============================================================
-- Case ID: TC_INCOMPLETE_TYPE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: incomplete_type_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity incomplete_type_decl_q2 is
  port (
    result : out integer
  );
end entity incomplete_type_decl_q2;

architecture comprehensive of incomplete_type_decl_q2 is
