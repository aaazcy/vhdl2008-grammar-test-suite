-- =============================================================
-- Case ID: TC_FILE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: file_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity file_declaration_q2 is
  port (
    result : out integer
  );
end entity file_declaration_q2;

architecture comprehensive of file_declaration_q2 is
