-- =============================================================
-- Case ID: TC_ATTRIBUTE_DECLARATION_SYN_005
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises attribute_declaration syntax variant 5 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity attribute_declaration_syn5 is
  port (
    clk  : in  bit;
    data : in  bit_vector(7 downto 0);
    q    : out bit_vector(7 downto 0)
  );
end entity attribute_declaration_syn5;

architecture rtl of attribute_declaration_syn5 is
