-- =============================================================
-- Case ID: TC_ATTRIBUTE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: attribute_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity attribute_declaratio_q2 is
  port (
    result : out integer
  );
end entity attribute_declaratio_q2;

architecture comprehensive of attribute_declaratio_q2 is
