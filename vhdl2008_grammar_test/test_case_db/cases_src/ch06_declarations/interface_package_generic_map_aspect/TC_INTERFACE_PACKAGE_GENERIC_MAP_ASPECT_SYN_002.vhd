-- =============================================================
-- Case ID: TC_INTERFACE_PACKAGE_GENERIC_MAP_ASPECT_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: interface_package_generic_map_aspect: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_package_ge_q2 is
  port (
    result : out integer
  );
end entity interface_package_ge_q2;

architecture comprehensive of interface_package_ge_q2 is
