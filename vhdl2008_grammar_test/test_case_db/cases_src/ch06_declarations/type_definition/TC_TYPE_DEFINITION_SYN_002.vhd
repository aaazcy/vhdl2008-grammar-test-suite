-- =============================================================
-- Case ID: TC_TYPE_DEFINITION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: type_definition: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity type_definition_q2 is
  port (
    result : out integer
  );
end entity type_definition_q2;

architecture comprehensive of type_definition_q2 is
