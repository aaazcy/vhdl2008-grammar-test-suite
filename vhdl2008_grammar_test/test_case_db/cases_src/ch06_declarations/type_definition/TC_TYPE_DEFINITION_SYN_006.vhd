-- =============================================================
-- Case ID: TC_TYPE_DEFINITION_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises type_definition syntax variant 6 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity type_definition_syn6 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 255;
    data  : out bit_vector(7 downto 0)
  );
end entity type_definition_syn6;

architecture rtl of type_definition_syn6 is
