-- =============================================================
-- Case ID: TC_TYPE_DEFINITION_SYN_012
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises type_definition syntax variant 12 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity type_definition_syn12 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 15;
    data  : out bit_vector(3 downto 0)
  );
end entity type_definition_syn12;

architecture rtl of type_definition_syn12 is
