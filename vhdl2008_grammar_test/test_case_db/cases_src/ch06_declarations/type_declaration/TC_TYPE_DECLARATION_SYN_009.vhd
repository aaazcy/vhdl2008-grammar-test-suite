-- =============================================================
-- Case ID: TC_TYPE_DECLARATION_SYN_009
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises type_declaration syntax variant 9 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity type_declaration_syn9 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 63;
    data  : out bit_vector(5 downto 0)
  );
end entity type_declaration_syn9;

architecture rtl of type_declaration_syn9 is
