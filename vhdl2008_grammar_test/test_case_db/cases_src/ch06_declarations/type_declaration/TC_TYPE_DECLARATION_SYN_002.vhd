...
-- Case Type: Positive
-- Test Focus: type_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity type_declaration_q2 is
  port (
    result : out integer
  );
end entity type_declaration_q2;

architecture comprehensive of type_declaration_q2 is
