-- =============================================================
-- Case ID: TC_ALIAS_DESIGNATOR_SYN_007
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises alias_designator syntax variant 7 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity alias_designator_syn7 is
  port (
    clk  : in  bit;
...
end entity alias_designator_syn7;

architecture rtl of alias_designator_syn7 is
