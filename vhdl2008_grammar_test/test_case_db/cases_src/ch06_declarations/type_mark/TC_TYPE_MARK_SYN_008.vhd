-- =============================================================
-- Case ID: TC_TYPE_MARK_SYN_008
-- Rule Type: Syntax
-- Related Rule ID: BNF_TYPE_MARK
-- Standard Reference: IEEE 1076-2008 Section 6.3
-- Production: type_mark ::= type_name subtype_name
-- Case Type: Positive
-- Test Focus: Exercises type_mark syntax variant 8 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity type_mark_syn8 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 15;
    data  : out bit_vector(3 downto 0)
  );
end entity type_mark_syn8;

architecture rtl of type_mark_syn8 is
