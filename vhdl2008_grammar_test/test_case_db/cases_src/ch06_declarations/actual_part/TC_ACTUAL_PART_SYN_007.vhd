-- =============================================================
-- Case ID: TC_ACTUAL_PART_SYN_007
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises actual_part syntax variant 7 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity actual_part_syn7 is
  port (
    a : in  bit_vector(4 downto 0);
    b : in  bit_vector(4 downto 0);
    y : out bit_vector(5 downto 0)
  );
end entity actual_part_syn7;

architecture rtl of actual_part_syn7 is
  component adder is
    port (
