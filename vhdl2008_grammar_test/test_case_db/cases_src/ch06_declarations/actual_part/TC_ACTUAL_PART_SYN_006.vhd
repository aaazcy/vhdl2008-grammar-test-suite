-- =============================================================
-- Case ID: TC_ACTUAL_PART_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises actual_part syntax variant 6 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity actual_part_syn6 is
  port (
    a : in  bit_vector(3 downto 0);
    b : in  bit_vector(3 downto 0);
    y : out bit_vector(4 downto 0)
  );
end entity actual_part_syn6;

architecture rtl of actual_part_syn6 is
  component adder is
    port (
