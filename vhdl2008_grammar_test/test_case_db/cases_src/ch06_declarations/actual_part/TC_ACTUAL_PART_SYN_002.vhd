-- =============================================================
-- Case ID: TC_ACTUAL_PART_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: actual_part: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity actual_part_q2 is
  port (
    result : out integer
  );
end entity actual_part_q2;

architecture comprehensive of actual_part_q2 is
