-- =============================================================
-- Case ID: TC_SUBTYPE_INDICATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: subtype_indication: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subtype_indication_q2 is
  port (
    result : out integer
  );
end entity subtype_indication_q2;

architecture comprehensive of subtype_indication_q2 is
