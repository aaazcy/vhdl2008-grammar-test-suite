-- =============================================================
-- Case ID: TC_SUBTYPE_INDICATION_SYN_008
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises subtype_indication syntax variant 8 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subtype_indication_syn8 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 15;
    data  : out bit_vector(3 downto 0)
  );
end entity subtype_indication_syn8;

architecture rtl of subtype_indication_syn8 is
