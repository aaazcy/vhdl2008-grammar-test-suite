-- =============================================================
-- Case ID: TC_IDENTIFIER_LIST_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: identifier_list: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity identifier_list_q2 is
  port (
    result : out integer
  );
end entity identifier_list_q2;

architecture comprehensive of identifier_list_q2 is
