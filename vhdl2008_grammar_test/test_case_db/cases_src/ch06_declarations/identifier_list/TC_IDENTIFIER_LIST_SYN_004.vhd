-- =============================================================
-- Case ID: TC_IDENTIFIER_LIST_SYN_004
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises identifier_list syntax variant 4 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity identifier_list_syn4 is
  port (
    clk   : in  bit;
    data  : in  bit_vector(5 downto 0);
    valid : out bit
  );
end entity identifier_list_syn4;

architecture rtl of identifier_list_syn4 is
