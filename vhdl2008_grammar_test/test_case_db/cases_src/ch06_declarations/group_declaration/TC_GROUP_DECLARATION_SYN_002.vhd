-- =============================================================
-- Case ID: TC_GROUP_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: group_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity group_declaration_q2 is
  port (
    result : out integer
  );
end entity group_declaration_q2;

architecture comprehensive of group_declaration_q2 is
