-- =============================================================
-- Case ID: TC_DESIGNATOR_SYN_002
-- Rule Type: Syntax
-- Related Rule ID: BNF_DESIGNATOR
-- Standard Reference: IEEE 1076-2008 Section 6.5.7.1
-- Production: designator ::= identifier | operator_symbol
-- Case Type: Positive
-- Test Focus: designator: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity designator_q2 is
  port (
    result : out integer
  );
end entity designator_q2;

architecture comprehensive of designator_q2 is
