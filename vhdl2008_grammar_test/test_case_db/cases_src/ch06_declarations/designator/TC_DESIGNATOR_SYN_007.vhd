-- =============================================================
-- Case ID: TC_DESIGNATOR_SYN_007
-- Rule Type: Syntax
-- Related Rule ID: BNF_DESIGNATOR
-- Standard Reference: IEEE 1076-2008 Section 6.5.7.1
-- Production: designator ::= identifier | operator_symbol
-- Case Type: Positive
-- Test Focus: Exercises designator syntax variant 7 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity designator_syn7 is
  port (
    a : in  bit_vector(4 downto 0);
    b : in  bit_vector(4 downto 0);
    y : out bit_vector(5 downto 0)
  );
end entity designator_syn7;

architecture rtl of designator_syn7 is
  component adder is
    port (
