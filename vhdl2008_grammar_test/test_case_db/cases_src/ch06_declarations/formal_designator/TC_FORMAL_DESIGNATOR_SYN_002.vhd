-- =============================================================
-- Case ID: TC_FORMAL_DESIGNATOR_SYN_002
-- Rule Type: Syntax
-- Related Rule ID: BNF_FORMAL_DESIGNATOR
-- Standard Reference: IEEE 1076-2008 Section 6.5.7.1
-- Production: formal_designator ::= generic_name port_name | parameter_name
-- Case Type: Positive
-- Test Focus: formal_designator: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity formal_designator_q2 is
  port (
    result : out integer
  );
end entity formal_designator_q2;

architecture comprehensive of formal_designator_q2 is
