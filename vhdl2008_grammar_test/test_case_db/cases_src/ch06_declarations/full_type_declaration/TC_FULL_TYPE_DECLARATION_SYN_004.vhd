-- =============================================================
-- Case ID: TC_FULL_TYPE_DECLARATION_SYN_004
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises full_type_declaration syntax variant 4 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity full_type_declaration_syn4 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 15;
    data  : out bit_vector(3 downto 0)
  );
end entity full_type_declaration_syn4;

architecture rtl of full_type_declaration_syn4 is
