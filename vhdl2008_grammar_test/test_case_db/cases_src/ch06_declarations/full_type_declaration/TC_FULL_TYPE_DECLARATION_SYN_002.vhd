-- =============================================================
-- Case ID: TC_FULL_TYPE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: full_type_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity full_type_declaratio_q2 is
  port (
    result : out integer
  );
end entity full_type_declaratio_q2;

architecture comprehensive of full_type_declaratio_q2 is
