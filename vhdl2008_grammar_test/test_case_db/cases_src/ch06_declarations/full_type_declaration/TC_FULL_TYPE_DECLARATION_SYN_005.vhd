-- =============================================================
-- Case ID: TC_FULL_TYPE_DECLARATION_SYN_005
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises full_type_declaration syntax variant 5 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity full_type_declaration_syn5 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 63;
    data  : out bit_vector(5 downto 0)
  );
end entity full_type_declaration_syn5;

architecture rtl of full_type_declaration_syn5 is
