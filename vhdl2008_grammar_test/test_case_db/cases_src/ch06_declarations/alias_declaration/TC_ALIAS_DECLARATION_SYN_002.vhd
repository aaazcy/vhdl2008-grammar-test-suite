-- =============================================================
-- Case ID: TC_ALIAS_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: alias_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity alias_declaration_q2 is
  port (
    result : out integer
  );
end entity alias_declaration_q2;

architecture comprehensive of alias_declaration_q2 is
