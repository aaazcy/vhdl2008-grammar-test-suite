-- =============================================================
-- Case ID: TC_ALIAS_DECLARATION_SYN_005
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises alias_declaration syntax variant 5 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity alias_declaration_syn5 is
  port (
    clk  : in  bit;
...
end entity alias_declaration_syn5;

architecture rtl of alias_declaration_syn5 is
