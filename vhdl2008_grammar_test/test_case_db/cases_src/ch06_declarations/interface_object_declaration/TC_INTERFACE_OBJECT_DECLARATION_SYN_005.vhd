-- =============================================================
-- Case ID: TC_INTERFACE_OBJECT_DECLARATION_SYN_005
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises interface_object_declaration syntax variant 5 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_object_declarat_syn5 is
  port (
    clk   : in  bit;
...
end entity interface_object_declarat_syn5;

architecture rtl of interface_object_declarat_syn5 is
