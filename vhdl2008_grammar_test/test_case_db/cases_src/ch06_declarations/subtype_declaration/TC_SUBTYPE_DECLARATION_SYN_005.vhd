...
-- Case Type: Positive
-- Test Focus: Exercises subtype_declaration syntax variant 5 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subtype_declaration_syn5 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 63;
    data  : out bit_vector(5 downto 0)
  );
end entity subtype_declaration_syn5;

architecture rtl of subtype_declaration_syn5 is
