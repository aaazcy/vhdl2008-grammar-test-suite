...
-- Case Type: Positive
-- Test Focus: Exercises subtype_declaration syntax variant 7 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subtype_declaration_syn7 is
  port (
    clk   : in  bit;
    addr  : in  integer range 0 to 1023;
    data  : out bit_vector(9 downto 0)
  );
end entity subtype_declaration_syn7;

architecture rtl of subtype_declaration_syn7 is
