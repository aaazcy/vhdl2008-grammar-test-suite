-- =============================================================
-- Case ID: TC_SUBTYPE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: subtype_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subtype_declaration_q2 is
  port (
    result : out integer
  );
end entity subtype_declaration_q2;

architecture comprehensive of subtype_declaration_q2 is
