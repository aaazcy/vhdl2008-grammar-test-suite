-- =============================================================
-- Case ID: TC_INTERFACE_FILE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: interface_file_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_file_decla_q2 is
  port (
    result : out integer
  );
end entity interface_file_decla_q2;

architecture comprehensive of interface_file_decla_q2 is
