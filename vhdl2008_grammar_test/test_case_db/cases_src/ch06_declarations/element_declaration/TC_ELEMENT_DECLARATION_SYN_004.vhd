...
-- Case Type: Positive
-- Test Focus: Exercises element_declaration syntax variant 4 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity element_declaration_syn4 is
  port (
    clk   : in  bit;
    data  : in  bit_vector(5 downto 0);
    valid : out bit
  );
end entity element_declaration_syn4;

architecture rtl of element_declaration_syn4 is
