...
-- Case Type: Positive
-- Test Focus: element_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity element_declaration_q2 is
  port (
    result : out integer
  );
end entity element_declaration_q2;

architecture comprehensive of element_declaration_q2 is
