...
-- Case Type: Positive
-- Test Focus: Exercises element_declaration syntax variant 5 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity element_declaration_syn5 is
  port (
    clk   : in  bit;
    data  : in  bit_vector(7 downto 0);
    valid : out bit
  );
end entity element_declaration_syn5;

architecture rtl of element_declaration_syn5 is
