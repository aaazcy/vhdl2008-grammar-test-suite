-- =============================================================
-- Case ID: TC_INTERFACE_DECLARATION_SYN_008
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises interface_declaration syntax variant 8 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_declaration_syn8 is
  port (
    clk   : in  bit;
...
end entity interface_declaration_syn8;

architecture rtl of interface_declaration_syn8 is
