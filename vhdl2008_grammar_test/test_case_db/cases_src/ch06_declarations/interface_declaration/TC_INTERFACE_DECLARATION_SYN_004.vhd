-- =============================================================
-- Case ID: TC_INTERFACE_DECLARATION_SYN_004
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises interface_declaration syntax variant 4 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_declaration_syn4 is
  port (
    clk   : in  bit;
...
end entity interface_declaration_syn4;

architecture rtl of interface_declaration_syn4 is
