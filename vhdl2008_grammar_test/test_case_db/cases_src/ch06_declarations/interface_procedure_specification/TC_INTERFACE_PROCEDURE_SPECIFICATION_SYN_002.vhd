-- =============================================================
-- Case ID: TC_INTERFACE_PROCEDURE_SPECIFICATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: interface_procedure_specification: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_procedure_q2 is
  port (
    result : out integer
  );
end entity interface_procedure_q2;

architecture comprehensive of interface_procedure_q2 is
