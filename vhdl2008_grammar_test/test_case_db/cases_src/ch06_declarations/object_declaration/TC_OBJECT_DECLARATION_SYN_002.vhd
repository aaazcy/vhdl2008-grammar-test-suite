-- =============================================================
-- Case ID: TC_OBJECT_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: object_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity object_declaration_q2 is
  port (
    result : out integer
  );
end entity object_declaration_q2;

architecture comprehensive of object_declaration_q2 is
