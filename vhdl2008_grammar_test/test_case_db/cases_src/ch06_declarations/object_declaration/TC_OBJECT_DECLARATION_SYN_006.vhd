-- =============================================================
-- Case ID: TC_OBJECT_DECLARATION_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises object_declaration syntax variant 6 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity object_declaration_syn6 is
  port (
    clk   : in  bit;
    data  : in  bit_vector(9 downto 0);
    accum : out integer range 0 to 32
  );
end entity object_declaration_syn6;

architecture rtl of object_declaration_syn6 is
