-- =============================================================
-- Case ID: TC_INTERFACE_INCOMPLETE_TYPE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: interface_incomplete_type_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_incomplete_q2 is
  port (
    result : out integer
  );
end entity interface_incomplete_q2;

architecture comprehensive of interface_incomplete_q2 is
