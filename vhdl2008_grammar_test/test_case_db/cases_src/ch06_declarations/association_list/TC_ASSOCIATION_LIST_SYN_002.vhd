-- =============================================================
-- Case ID: TC_ASSOCIATION_LIST_SYN_002
-- Rule Type: Syntax
-- Related Rule ID: BNF_ASSOCIATION_LIST
-- Standard Reference: IEEE 1076-2008 Section 6.5.7.1
-- Production: association_list ::= association_element { , association_element }
-- Case Type: Positive
-- Test Focus: association_list: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity association_list_q2 is
  port (
    result : out integer
  );
end entity association_list_q2;

architecture comprehensive of association_list_q2 is
