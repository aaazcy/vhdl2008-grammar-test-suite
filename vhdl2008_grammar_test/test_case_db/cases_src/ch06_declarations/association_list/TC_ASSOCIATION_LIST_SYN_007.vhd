-- =============================================================
-- Case ID: TC_ASSOCIATION_LIST_SYN_007
-- Rule Type: Syntax
-- Related Rule ID: BNF_ASSOCIATION_LIST
-- Standard Reference: IEEE 1076-2008 Section 6.5.7.1
-- Production: association_list ::= association_element { , association_element }
-- Case Type: Positive
-- Test Focus: Exercises association_list syntax variant 7 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity association_list_syn7 is
  port (
    a : in  bit_vector(4 downto 0);
    b : in  bit_vector(4 downto 0);
    y : out bit_vector(5 downto 0)
  );
end entity association_list_syn7;

architecture rtl of association_list_syn7 is
  component adder is
    port (
