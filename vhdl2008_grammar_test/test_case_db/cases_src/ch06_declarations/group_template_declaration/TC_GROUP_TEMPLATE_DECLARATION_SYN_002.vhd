-- =============================================================
-- Case ID: TC_GROUP_TEMPLATE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: group_template_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity group_template_decla_q2 is
  port (
    result : out integer
  );
end entity group_template_decla_q2;

architecture comprehensive of group_template_decla_q2 is
