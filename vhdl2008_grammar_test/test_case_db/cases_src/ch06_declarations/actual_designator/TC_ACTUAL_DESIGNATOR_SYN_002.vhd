-- =============================================================
-- Case ID: TC_ACTUAL_DESIGNATOR_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: actual_designator: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity actual_designator_q2 is
  port (
    result : out integer
  );
end entity actual_designator_q2;

architecture comprehensive of actual_designator_q2 is
