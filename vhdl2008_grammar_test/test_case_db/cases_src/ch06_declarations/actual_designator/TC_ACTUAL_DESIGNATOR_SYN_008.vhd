-- =============================================================
-- Case ID: TC_ACTUAL_DESIGNATOR_SYN_008
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises actual_designator syntax variant 8 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity actual_designator_syn8 is
  port (
    a : in  bit_vector(1 downto 0);
    b : in  bit_vector(1 downto 0);
    y : out bit_vector(2 downto 0)
  );
end entity actual_designator_syn8;

architecture rtl of actual_designator_syn8 is
  component adder is
    port (
