...
-- Case Type: Positive
-- Test Focus: entity_tag: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity entity_tag_q2 is
  port (
    result : out integer
  );
end entity entity_tag_q2;

architecture comprehensive of entity_tag_q2 is
