...
-- Case Type: Positive
-- Test Focus: Exercises entity_tag syntax variant 7 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity entity_tag_syn7 is
  port (
    clk  : in  bit;
    data : in  bit_vector(7 downto 0);
    q    : out bit_vector(7 downto 0)
  );
end entity entity_tag_syn7;

architecture rtl of entity_tag_syn7 is
