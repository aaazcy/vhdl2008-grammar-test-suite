-- =============================================================
-- Case ID: TC_INTERFACE_SIGNAL_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: interface_signal_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity interface_signal_dec_q2 is
  port (
    result : out integer
  );
end entity interface_signal_dec_q2;

architecture comprehensive of interface_signal_dec_q2 is
