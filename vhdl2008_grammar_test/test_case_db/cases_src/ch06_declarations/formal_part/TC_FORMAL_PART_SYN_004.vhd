-- =============================================================
-- Case ID: TC_FORMAL_PART_SYN_004
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises formal_part syntax variant 4 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity formal_part_syn4 is
  port (
    a : in  bit_vector(1 downto 0);
    b : in  bit_vector(1 downto 0);
    y : out bit_vector(2 downto 0)
  );
end entity formal_part_syn4;

architecture rtl of formal_part_syn4 is
  component adder is
    port (
