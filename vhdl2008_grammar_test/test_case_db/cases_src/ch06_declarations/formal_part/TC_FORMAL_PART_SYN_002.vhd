-- =============================================================
-- Case ID: TC_FORMAL_PART_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: formal_part: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity formal_part_q2 is
  port (
    result : out integer
  );
end entity formal_part_q2;

architecture comprehensive of formal_part_q2 is
