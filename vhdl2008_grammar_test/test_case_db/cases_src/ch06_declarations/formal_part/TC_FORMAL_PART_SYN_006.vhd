-- =============================================================
-- Case ID: TC_FORMAL_PART_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: Exercises formal_part syntax variant 6 with progressively complex VHDL structures exercising the full BNF production.
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity formal_part_syn6 is
  port (
    a : in  bit_vector(3 downto 0);
    b : in  bit_vector(3 downto 0);
    y : out bit_vector(4 downto 0)
  );
end entity formal_part_syn6;

architecture rtl of formal_part_syn6 is
  component adder is
    port (
