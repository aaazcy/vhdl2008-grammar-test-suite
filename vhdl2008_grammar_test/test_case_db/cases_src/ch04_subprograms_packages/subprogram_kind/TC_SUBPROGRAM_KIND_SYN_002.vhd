-- =============================================================
-- Case ID: TC_SUBPROGRAM_KIND_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: subprogram_kind: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subprogram_kind_q2 is
  port (
    result : out integer
  );
end entity subprogram_kind_q2;

architecture comprehensive of subprogram_kind_q2 is
