-- =============================================================
-- Case ID: TC_FORMAL_PARAMETER_LIST_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: formal_parameter_list: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity formal_parameter_lis_q2 is
  port (
    result : out integer
  );
end entity formal_parameter_lis_q2;

architecture comprehensive of formal_parameter_lis_q2 is
