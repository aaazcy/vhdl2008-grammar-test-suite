-- =============================================================
-- Case ID: TC_SUBPROGRAM_BODY_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: subprogram_body: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity subprogram_body_q2 is
  port (
    result : out integer
  );
end entity subprogram_body_q2;

architecture comprehensive of subprogram_body_q2 is
