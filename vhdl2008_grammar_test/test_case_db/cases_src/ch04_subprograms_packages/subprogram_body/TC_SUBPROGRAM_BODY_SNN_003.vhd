-- =============================================================
-- Case ID: TC_SUBPROGRAM_BODY_SNN_003
-- Rule Type: Syntax
...
-- Case Type: Negative
-- Test Focus: subprogram_body: type mismatch in declaration
-- Expected Result: Triggers syntax/semantic error
-- Dependencies: None
-- =============================================================
entity subprogram_body_e3 is end entity;
architecture bh of subprogram_body_e3 is
