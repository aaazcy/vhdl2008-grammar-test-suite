...
-- Case Type: Positive
-- Test Focus: signature: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity signature_q2 is
  port (
    result : out integer
  );
end entity signature_q2;

architecture comprehensive of signature_q2 is
