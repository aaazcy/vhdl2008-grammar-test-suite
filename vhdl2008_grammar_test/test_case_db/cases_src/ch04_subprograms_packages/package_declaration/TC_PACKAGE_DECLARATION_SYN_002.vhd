-- =============================================================
-- Case ID: TC_PACKAGE_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: package_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity package_declaration_q2 is
  port (
    result : out integer
  );
end entity package_declaration_q2;

architecture comprehensive of package_declaration_q2 is
