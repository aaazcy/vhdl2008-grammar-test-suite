-- =============================================================
-- Case ID: TC_CONTEXT_DECLARATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: context_declaration: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity context_declaration_q2 is
  port (
    result : out integer
  );
end entity context_declaration_q2;

architecture comprehensive of context_declaration_q2 is
