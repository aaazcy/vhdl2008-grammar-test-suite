-- =============================================================
-- Case ID: TC_ARCHITECTURE_BODY_SNN_001
-- Rule Type: Syntax
...
-- Case Type: Negative
-- Test Focus: missing "of" keyword
-- Expected Result: Triggers syntax error: missing "of" keyword
-- Dependencies: None
-- =============================================================
entity arch_snn1_ent is port(a:in bit; y:out bit); end entity;
architecture behav arch_snn1_ent is begin y<=a; end architecture behav;
