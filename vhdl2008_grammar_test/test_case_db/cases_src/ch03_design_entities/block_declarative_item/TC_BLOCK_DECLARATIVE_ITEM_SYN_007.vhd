-- =============================================================
-- Case ID: TC_BLOCK_DECLARATIVE_ITEM_SYN_007
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: block_declarative_item: with for-generate and block structure
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity block_declarative_it_q3 is
  port (
    result : out integer
  );
end entity block_declarative_it_q3;

architecture comprehensive of block_declarative_it_q3 is
