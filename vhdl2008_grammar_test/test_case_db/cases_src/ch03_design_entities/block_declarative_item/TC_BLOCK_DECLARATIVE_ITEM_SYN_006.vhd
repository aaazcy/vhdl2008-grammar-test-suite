-- =============================================================
-- Case ID: TC_BLOCK_DECLARATIVE_ITEM_SYN_006
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: block_declarative_item: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity block_declarative_it_q2 is
  port (
    result : out integer
  );
end entity block_declarative_it_q2;

architecture comprehensive of block_declarative_it_q2 is
