-- =============================================================
-- Case ID: TC_DISCRETE_RANGE_SYN_002
-- Rule Type: Syntax
-- Related Rule ID: BNF_DISCRETE_RANGE
-- Standard Reference: IEEE 1076-2008 Section 5.3.2.1
-- Production: discrete_range ::= discrete_subtype_indication | range
-- Case Type: Positive
-- Test Focus: discrete_range: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity discrete_range_q2 is
  port (
    result : out integer
  );
end entity discrete_range_q2;

architecture comprehensive of discrete_range_q2 is
