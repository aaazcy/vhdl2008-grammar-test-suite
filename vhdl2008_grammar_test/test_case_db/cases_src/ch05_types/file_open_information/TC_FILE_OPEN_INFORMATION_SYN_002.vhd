-- =============================================================
-- Case ID: TC_FILE_OPEN_INFORMATION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: file_open_information: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity file_open_informatio_q2 is
  port (
    result : out integer
  );
end entity file_open_informatio_q2;

architecture comprehensive of file_open_informatio_q2 is
