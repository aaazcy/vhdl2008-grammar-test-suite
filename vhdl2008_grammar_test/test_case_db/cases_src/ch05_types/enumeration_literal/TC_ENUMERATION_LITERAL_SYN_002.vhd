-- =============================================================
-- Case ID: TC_ENUMERATION_LITERAL_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: enumeration_literal: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity enumeration_literal_q2 is
  port (
    result : out integer
  );
end entity enumeration_literal_q2;

architecture comprehensive of enumeration_literal_q2 is
