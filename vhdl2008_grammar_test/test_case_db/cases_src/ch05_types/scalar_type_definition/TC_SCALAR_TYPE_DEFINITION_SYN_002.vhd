-- =============================================================
-- Case ID: TC_SCALAR_TYPE_DEFINITION_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: scalar_type_definition: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity scalar_type_definiti_q2 is
  port (
    result : out integer
  );
end entity scalar_type_definiti_q2;

architecture comprehensive of scalar_type_definiti_q2 is
