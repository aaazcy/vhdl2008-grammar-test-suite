...
-- Case Type: Positive
-- Test Focus: use_clause: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity use_clause_q2 is
  port (
    result : out integer
  );
end entity use_clause_q2;

architecture comprehensive of use_clause_q2 is
