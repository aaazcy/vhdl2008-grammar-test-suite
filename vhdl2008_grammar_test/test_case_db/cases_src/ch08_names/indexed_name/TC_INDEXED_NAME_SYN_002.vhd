-- =============================================================
-- Case ID: TC_INDEXED_NAME_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: indexed_name: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity indexed_name_q2 is
  port (
    result : out integer
  );
end entity indexed_name_q2;

architecture comprehensive of indexed_name_q2 is
