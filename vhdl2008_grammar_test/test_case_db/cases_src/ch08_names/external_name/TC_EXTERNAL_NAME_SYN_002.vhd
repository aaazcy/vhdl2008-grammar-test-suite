-- =============================================================
-- Case ID: TC_EXTERNAL_NAME_SYN_002
-- Rule Type: Syntax
...
-- Case Type: Positive
-- Test Focus: external_name: with function and procedure declarations
-- Expected Result: Compiles successfully
-- Dependencies: None
-- =============================================================
entity external_name_q2 is
  port (
    result : out integer
  );
end entity external_name_q2;

architecture comprehensive of external_name_q2 is
